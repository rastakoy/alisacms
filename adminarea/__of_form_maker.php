...
<div class="fm_panel_group">
	<div class="fm_panel_button" onClick="insert_inputcheckbox()">
	<img src="images/of/fm_add_inputcheckbox.gif" width="16" height="16"></div>
	<div class="fm_panel_button"><img src="images/of/fm_add_inputtext.gif" width="16" height="16"></div>
	<div class="fm_panel_button"><img src="images/of/fm_add_textarea.gif" width="16" height="16"></div>
	<div class="fm_panel_button">
