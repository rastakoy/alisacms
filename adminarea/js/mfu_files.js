 ...
 */
qq.FileUploader_files = function(o){
    this._options = {
        ...
        template: '<div class="qq-uploader">' + 
                ...
                '<div class="fast_table_upload_button">&nbsp;</div>' +
        ...
        classes: {
            ...
            button: 'fast_table_upload_button',
    ...
    if (this._element.nodeType != 1){
        throw new Error('element param of FileUploader_files should be dom node');
    }
...
qq.FileUploader_files.prototype = {
...
qq.UploadHandlerForm.prototype = {
    ...
    _createIframe: function(id){
        ...
        var iframe = qq.toElement('<iframe src="__iframe.php" name="' + id + '"/>');
