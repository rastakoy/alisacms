...
if(!$stop_send){
	...
	color: #333333;
		...
		//print_r($user);
		//echo $cont;
		//__fpost_send_mail("Сайт poklevka.net.ua", 
		//$user["email"], 
		//$user["fio"], 
		//"info@poklevka.net.ua", 
		//"Заказ с интернет-магазина poklevka.net.ua", 
		//$cont, 
		//"poklevka.net.ua", 
		...
		$headers .= 'From: info@poklevka.net.ua' . "\r\n";
		mail($user["email"], 'Заказ с интернет-магазина poklevka.net.ua', $cont, $headers);
		mail("mvdovchenko@ukr.net", 'Заказ с интернет-магазина poklevka.net.ua', $cont, $headers);
		//mail("info@poklevka.net.ua", 'Заказ с интернет-магазина poklevka.net.ua', $cont, $headers);
		//**************************************
		//__fpost_send_mail("Сайт poklevka.net.ua", 
		//"info@poklevka.net.ua", 
		//$user["fio"], 
